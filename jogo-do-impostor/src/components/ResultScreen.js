    ...
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.summaryContainer}>
          <Text style={styles.summaryTitle}>RESUMO DA SALA ({players.length} JOGADORES)</Text>
          {players.map((p) => (
...
const styles = StyleSheet.create({
  ...
  wordCards: { gap: 8, marginVertical: 16 },
  ...
  summaryContainer: { backgroundColor: '#FFFFFF', padding: 16, borderRadius: 10, borderWidth: 1, borderColor: '#E5E7EB', marginBottom: 12 },
  summaryTitle: { fontSize: 12, fontWeight: '700', color: '#6B7280', marginBottom: 8 },
  summaryRow: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 6, borderBottomWidth: 0.5, borderBottomColor: '#F3F4F6' },
